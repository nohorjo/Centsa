...
public class MockDAO<T> {
    ...
    public static final String ORDER = RandomStringUtils.randomAlphabetic(10),
            NAME = RandomStringUtils.randomAlphabetic(10), NAME_2 = RandomStringUtils.randomAlphabetic(10);
    ...
    public Long handleGetIdByName(String name) throws SQLException {
        switch (option) {
            case FINE:
                return name.equals(NAME_2) ? ID : null;
            case ERROR:
                throw new SQLException();
            case NONE:
        }
