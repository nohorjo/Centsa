...
page << "\n";
page << "/**\n";
page << " * Coverts all child user-changeables to JSON string\n";
page << " * @param {*} id id of the element\n";
page << " */\n";
page << "function serializeElement(id) {\n";
page << "    var form0 = {};\n";
page << "    $(\"#\" + id).find(\"input:not([type='button']), select, textarea\").each(function () {\n";
page << "        form0[this.name] = this.value;\n";
page << "    });\n";
page << "    return JSON.stringify(form0);\n";
page << "}\n";
page << "\n";
page << "function alertHi() {\n";
page << "    alert(serializeElement(\"transactionDetails\"));\n";
page << "}\n";
page << "\n";
page << "/**\n";
page << " * Keep the server alive\n";
page << " */\n";
page << "setInterval(function () { $.get(\"/ping\"); }, 15000);</script>\n";
page << "</head>\n";
page << "\n";
...
page << "    <br> two %%\n";
page << "    <hr>\n";
page << "    <table id=\"transactionDetails\">\n";
page << "        <tbody>\n";
page << "            <tr>\n";
page << "                <td>Amount</td>\n";
page << "                <td><input name=\"AMOUNT\" type=\"number\" step='0.01' value='0.00' placeholder='0.00'></td>\n";
page << "            </tr>\n";
page << "            <tr>\n";
page << "                <td>Comment</td>\n";
page << "                <td><textarea name=\"COMMENT\" rows=\"3\" cols=\"40\"></textarea></td>\n";
page << "            </tr>\n";
page << "            <tr>\n";
page << "                <td>Account</td>\n";
page << "                <td><select name=\"ACCOUNT\">\n";
...
page << "            <tr>\n";
page << "                <td>Date</td>\n";
page << "                <td><input name=\"DATE\" id=\"transDate\"></td>\n";
page << "            </tr>\n";
page << "            <tr>\n";
page << "                <td>Expense</td>\n";
page << "                <td><select name=\"EXPENSE\">\n";
